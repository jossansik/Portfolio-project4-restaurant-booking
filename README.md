...
* [Setup project locally](https://github.com/jossansik/Portfolio-project4-restaurant-booking#Setup-project-locally)
...
- cmd: 'npm install' - To get all javascript dependencies installed
...
To run tests, run the following command: coverage run manage.py test restaurant_app -v 2
